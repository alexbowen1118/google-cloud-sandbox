...
class CreateCounterRuleAction extends Action
{
  /**
   * {@inheritdoc}
   */
  protected function action(): Response
  {
    ...
    $result = [
      'counter_rule' => $counterRuleDAO->createCounterRule($counter_rule)
    ];

    $this->logger->info("Device counter rule was created.");
