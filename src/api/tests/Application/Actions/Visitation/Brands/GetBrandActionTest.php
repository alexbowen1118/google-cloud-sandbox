...
class GetBrandActionTest extends TestCase
{
    ...
    public function getBrand($brandData)
    {
        ...
        // Actual Results: Call the GET api/visitation/brands/1 endpoint
        $request = $this->createRequest('GET', 'api/visitation/brands/1');
