...
class UpdateTypeActionTest extends TestCase
{
    ...
    public function createType($typeData)
    {
        ...
        // Actual Results: Call the PUT api/visitation/types/1 endpoint
        $request = $this->createRequest('PUT', 'api/visitation/types/1');
