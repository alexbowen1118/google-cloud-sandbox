...
class GetFunctionActionTest extends TestCase
{

    public function getFunctionCases()
    {
        return array(
            # 1 active function
            array(
    ...
    /** 
     * @test 
     * @dataProvider getFunctionCases
     */
    public function getFunction($functionData)
    {
        ...
        // Actual Results: Call the GET api/visitation/functions/1 endpoint
        $request = $this->createRequest('GET', 'api/visitation/functions/1');
