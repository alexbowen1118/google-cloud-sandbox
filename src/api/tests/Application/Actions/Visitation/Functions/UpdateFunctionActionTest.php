...
class UpdateFunctionActionTest extends TestCase
{
    ...
    public function createFunction($functionData)
    {
        ...
        // Actual Results: Call the PUT api/visitation/functions/1 endpoint
        $request = $this->createRequest('PUT', 'api/visitation/functions/1');
