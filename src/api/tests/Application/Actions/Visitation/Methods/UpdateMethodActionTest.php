...
class UpdateMethodActionTest extends TestCase
{
    ...
    public function createMethod($methodData)
    {
        ...
        $method->setName('Updated Method Name');
        ...
        // Actual Results: Call the PUT api/visitation/methods/1 endpoint
        $request = $this->createRequest('PUT', 'api/visitation/methods/1');
