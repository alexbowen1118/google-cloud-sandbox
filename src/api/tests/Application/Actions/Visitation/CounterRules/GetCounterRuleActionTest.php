...
class GetCounterRuleActionTest extends TestCase
{

    public function getCounterRuleCases()
    {
        return array(
    ...
    /** 
     * @test 
     * @dataProvider getCounterRuleCases
     */
    public function getCounterRule($counter_ruleData)
    {
        ...
        // Actual Results: Call the GET api/visitation/counter_rules/1 endpoint
        $request = $this->createRequest('GET', 'api/visitation/counter_rules/1');
