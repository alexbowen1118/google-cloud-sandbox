...
class CreateCounterRuleActionTest extends TestCase
{
     ...
     */
    public function createCounterRule($counterRuleData)
    {
        ...
        $counter_rule = new CounterRule($counterRuleData);
        ...
        // Actual Results: Call the POST api/visitation/counter_rules endpoint
        $request = $this->createRequest('POST', 'api/visitation/counter_rules');
