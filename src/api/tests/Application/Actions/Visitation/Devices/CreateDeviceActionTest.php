...
class CreateDeviceActionTest extends TestCase
{
    ...
    public function createDeviceCases()
    {
        return array(
            # 1 active park
            array(
                array("dev_id" => 1, "dev_par_id" => 218, "dev_number" => "e00fce689551d15474a18e59", "dev_name" => "ENRI Counter 1", "dev_function" => 2, "dev_type" => 3, "dev_method" => 2, "dev_model" => 3, "dev_brand" => 2, "dev_multiplier" => 1.0, "dev_lat" => 36.39766000, "dev_lon" => -81.47346600, "dev_seeinsight_id" => "60ca4da51d8472746e1b7b75", "dev_date_uploaded" => "2022-07-01 00:00:00", "dev_status" => 1)
            ),
            # 1 active park
            array(
                array("dev_id" => 1, "dev_par_id" => 218, "dev_number" => "e00fce68c7dbfc82feb8701f", "dev_name" => "ENRI Counter 2", "dev_function" => 1, "dev_type" => 1, "dev_method" => 1, "dev_model" => 2, "dev_brand" => 2, "dev_multiplier" => 3.5, "dev_lat" => 36.07830000, "dev_lon" => -79.00500000, "dev_seeinsight_id" => "60ca4da51d8472746e1b7b34", "dev_date_uploaded" => "2022-06-02 00:00:00", "dev_status" => 1)
            )
        );
    }
    ...
    public function createDevice($deviceData)
    {
        ...
        // Actual Results: Call the POST api/visitation/devices endpoint
        $request = $this->createRequest('POST', 'api/visitation/devices');
