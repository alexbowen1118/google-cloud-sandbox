...
class DeleteDeviceActionTest extends TestCase
{
    ...
    public function deleteDeviceCases()
    {
        return array(
            # 1 active park
            array(
    ...
    /** 
     * @test 
     * @dataProvider deleteDeviceCases
     */
    public function deleteDevice($deviceData)
    {
        ...
        // Actual Results: Call the DELETE api/visitation/devices/1 endpoint
        $request = $this->createRequest('DELETE', 'api/visitation/devices/1');
