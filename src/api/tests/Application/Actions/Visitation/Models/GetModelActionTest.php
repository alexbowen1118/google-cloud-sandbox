...
class GetModelActionTest extends TestCase
{

    public function getModelCases()
    {
        return array(
            # 1 active model
            array(
    ...
    /** 
     * @test 
     * @dataProvider getModelCases
     */
    public function getModel($modelData)
    {
        ...
        // Actual Results: Call the GET api/visitation/models/1 endpoint
        $request = $this->createRequest('GET', 'api/visitation/models/1');
