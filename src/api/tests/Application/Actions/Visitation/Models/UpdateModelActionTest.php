...
class UpdateModelActionTest extends TestCase
{
    ...
    public function createModelCases()
    {
        return array(
            ...
            # 1 active model
            array(
                array("mdl_id" => 1, "mdl_name" => "Photo ", "mdl_status" => 1)
            )
        );
    }
    ...
    public function createModel($modelData)
    {
        ...
        // Actual Results: Call the PUT api/visitation/models/1 endpoint
        $request = $this->createRequest('PUT', 'api/visitation/models/1');
