...
class GetVisitActionTest extends TestCase
{

    public function getVisitCases()
    {
        return array(
            # 1 active visit
            array(
    ...
    /** 
     * @test 
     * @dataProvider getVisitCases
     */
    public function getVisit($visitData)
    {
        ...
        // Actual Results: Call the GET api/visitation/visits/1 endpoint
        $request = $this->createRequest('GET', 'api/visitation/visits/1');
