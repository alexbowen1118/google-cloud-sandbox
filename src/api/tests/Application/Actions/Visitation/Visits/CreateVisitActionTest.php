...
class CreateVisitActionTest extends TestCase
{
    ...
    public function createVisit($visitData)
    {
        ...
        // Actual Results: Call the POST api/visitation/visits endpoint
        $request = $this->createRequest('POST', 'api/visitation/visits');
