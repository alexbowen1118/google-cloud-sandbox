...
INSERT INTO `park` (`par_id`, `par_code`, `par_reg_id`, `par_admin_by`, `par_name`, `par_lat`, `par_lon`) VALUES
	(198, 'ARCH', NULL, NULL, 'At Raleigh Central Headquarters', 35.78690000, -78.63870000),
...
INSERT INTO `user` (`usr_id`, `usr_username`, `usr_password_hash`, `usr_par_id`, `usr_first_name`, `usr_middle_name`, `usr_last_name`, `usr_status`)
VALUES (1, 'permission-0', '$argon2id$v=19$m=65536,t=4,p=1$T1VGTzEwRDY0RzBzbE1rcQ$jd/8q8rQMyvn91bUEwpGgtsV5cyoCCFUtwi1fDkqcsQ', 199, 'NoAccess', 'Mname', 'Staff', 1),
    (2, 'permission-1', '$argon2id$v=19$m=65536,t=4,p=1$NnVldzZlcmU0a1R0aXc0bg$KdAn7yANwJxc4rhSW5+DXfbZVWD9584x2ALYFHnAYpg', 210, 'BaseLevel', 'Mname', 'Staff', 1),
    (3, 'permission-2', '$argon2id$v=19$m=65536,t=4,p=1$NEdyTzhMdTliTlhXU3dtVg$I3osaPHZk1idVPay5QPlu7BMxIy7OM9Gkqix2SI9gLQ', 260, 'Manager', 'Mname', 'Staff', 1),
    (4, 'permission-3', '$argon2id$v=19$m=65536,t=4,p=1$U0k2aXcudzVmbmRFdHo3ZQ$sEhSwE5HEwm0/lvQFGAf1XDPkkagi2kpJ8gmQPqfAn4', 198, 'Admin', 'Mname', 'Staff', 1),
    (5, 'permission-4', '$argon2id$v=19$m=65536,t=4,p=1$eWh3WC5OdDB0ZWJZQVNWLg$3n+aJN4D2Te48Jg9YMfM94PQZn50DrxqD86I+Ew0GGU', 198, 'SuperAdmin', 'Mname', 'Staff', 1);
...
INSERT INTO `visit` (`vis_id`,  `vis_par_id`, `vis_dev_id`, `vis_timestamp`, `vis_count`, `vis_count_calculated`, `vis_comments`, `vis_status`)
VALUES (1, 198, 1, TIMESTAMP("2023-01-02 08:00:00"), 15, 30, "I put this in myself", 1),
    (2, 198, 1, TIMESTAMP("2023-01-11 09:00:00"), 20, 30, "", 1),
    (3, 198, 1, TIMESTAMP("2023-01-16 12:00:00"), 20, 20, "Raw was correct", 1),
    (4, 198, 2, TIMESTAMP("2023-01-27 08:00:00"), 10, 30, "", 1),
    (5, 198, 2, TIMESTAMP("2023-02-01 14:00:00"), 1, 1, "Inactive Data", 0),
    (6, 198, 2, TIMESTAMP("2023-02-02 16:00:00"), 2, 6, "This website has comments?", 1);
...
VALUES
('Travel Authorization/Travel Request'),
('APC'),
('P-Card'),
('WEX'),
('Permits'),
