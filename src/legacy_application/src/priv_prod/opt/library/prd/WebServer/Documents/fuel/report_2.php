...
$a1="array";
$district_array=${$a1.$pass_district};
//echo "<pre>$district"; print_r($district_array);echo "</pre>";  //exit;
...
//echo "<pre>"; print_r($array); echo "</pre>";  exit;
	...
	foreach($district_array as $k1=>$v1)
		{
...
echo "<tr>
<td colspan='10' align='center'>$pass_district Total <b>Miles</b> driven for $year - <b>$answer1</b> miles</td></tr>";
...
foreach($district_array as $k=>$park)
	{
